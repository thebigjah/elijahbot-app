...
const APPS: AppEntry[] = [
  ...
  { id: 'screentime-analyzer', name: 'Screentime Analyzer', description: 'Screen time + AI analysis · NOT a web app — needs native iOS Screen Time API or Android UsageStatsManager · deferred to v1 native', url: 'about:blank', category: 'Coming Soon', icon: '📱', tier: 'app' },
  { id: 'smart-calendar', name: 'Smart Calendar', description: 'Calendar with rich per-event context · bio/prep/topics/watch-for · .ics import', url: `${HUB_BASE}/smart-calendar/`, category: 'Apps', icon: '📆', tier: 'app' },
  { id: 'magic-closet', name: 'Magic Closet', description: 'Wardrobe catalog + outfit picker · photos via IndexedDB · weighted by recency', url: `${HUB_BASE}/magic-closet/`, category: 'Apps', icon: '👔', tier: 'app' },
